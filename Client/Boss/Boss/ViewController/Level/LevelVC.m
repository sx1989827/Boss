...
- (void)viewDidLoad {
    ...
    [LevelInfoReq do:^(id req) {
        ...
        if(obj.code==0)
        {
            ...
            viewLevel=[[LevelView alloc] initWithNodes:[arrLevel subarrayWithRange:NSMakeRange(0, indexLevel+(indexLevel==arrLevel.count-1?1:2))] UserIndex:indexLevel MaxCount:arrLevel.count];
