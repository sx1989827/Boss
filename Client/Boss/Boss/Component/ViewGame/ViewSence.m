...
-(void)initTexture
{
    ...
    [ViewTexture registerAtlasName:@"经理" Count:5];
    [ViewTexture registerAtlasName:@"主管" Count:4];
    [ViewTexture registerAtlasName:@"副总监" Count:4];
    [ViewTexture registerAtlasName:@"总监" Count:4];
    [ViewTexture registerAtlasName:@"CTO" Count:4];
    [ViewTexture registerAtlasName:@"副总裁" Count:4];
    [ViewTexture registerAtlasName:@"总裁" Count:4];
    [ViewTexture registerAtlasName:@"hr" Count:4];
    [ViewTexture registerAtlasName:@"产品" Count:4];
    [ViewTexture registerAtlasName:@"运营" Count:4];
